...
echo "Enter your Location Name:"
read locationName

echo "Enter your Domain:https://"
read Domain
...
kubectl get secret root-ca-certificate ${KUBERNETES_NAMESPACE} -o go-template='{{index .data "tls.crt" }}' | base64 --decode > "${CLIENT_TRUSTSTORE}"
...
echo "Installing Lokahi Minion" 
helm upgrade --install lokahi-minion ../../lokahi-minion/ -f "../tmp/minion.yaml" 
